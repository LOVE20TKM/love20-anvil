...
export function buildEnvContent(graph, root = repoRoot) {
  ...
  const lines = ['# Generated by love20-anvil. Regenerate with npm run env.', ''];

  addSection(lines, 'App');
  addLine(lines, 'NEXT_PUBLIC_APP_VERSION', 'anvil');

  addSection(lines, 'Chain');
  ...
  addSection(lines, 'Periphery Addresses');
  ...
  addSection(lines, 'Group Addresses');
  ...
  addSection(lines, 'Group Chat Addresses');
  ...
  addSection(lines, 'Extension Addresses');
